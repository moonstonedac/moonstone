...
uint32_t aes_encoder::encode( const char* plaintxt, /*uint32_t*/int plaintext_len, char* ciphertxt )
{
...
uint32_t aes_decoder::decode( const char* ciphertxt, int ciphertxt_len, char* plaintext )
{
    int plaintext_len = 0;
